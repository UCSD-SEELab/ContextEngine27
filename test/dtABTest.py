...
inputFilePath = "DTABTestInput.csv"
outputFilePath = "DTABTestOutput.csv"
...
algorithmTest = DecisionTreeAB(complexity, 1, 0, [0], {})
teslaTimestamps = {};
dtABTimestamps = {};
...
for i in range(numRow):
	...
	secondTS = time.time()
	dtABTimestamps["load" + str(i-numRow*day_train_start)] = secondTS - firstTS
	preSum = 0
