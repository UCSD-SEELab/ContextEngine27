...
outputFilePath = "3192_occupancy.csv";
...
livingroom1PresenceThresh = 0.039
...
bathOccupancyColumnName = "BathroomOccupancy";
...
with open(elecFilePath) as csvFile:
    # Derived activities
    bathOccupancy = 0       # 0: 1: in kitchen 2: in bathroom
    isCooking = 0;
    isUsingWater = 0;
    ...
    for row in reader:
        ...
        if (i == 0):
            ...
            outputRow.append(bathOccupancyColumnName)
            ...
            bathOccupancy = 0
            if (float(row[bathroom1Column]) > bathroom1Nominal):
                bathOccupancy = 1
            ...
            outputRow.append(bathOccupancy);
